...
json McpServer::handleToolsList(const json& request) {
    json tools = json::array({
        {
            {"name", "mem_store"},
            {"description", "Store a memory with semantic key. Keys should be descriptive sentences like 'hms-cpap deploy process and steps' so semantic search works well."},
            {"inputSchema", {
                {"type", "object"},
                {"properties", {
        ...
        {
            {"name", "mem_search"},
            {"description", "Semantic search for memories. Describe what you're looking for in natural language."},
            {"inputSchema", {
                {"type", "object"},
                {"properties", {
